...
public class JwtServiceTest {
    ...
    void testExtractClaim() {
        ...
        when(jwtService.extractAllClaims("validToken")).thenReturn(mockClaims);

        // Simuler la fonction qui sera passée à extractClaim
        Function<Claims, T> claimsResolver = Claims::getSubject;
        ...
        assertEquals(username, actualUserName, "Le nom d'utilisateur extrait doit être correct");
    }
    @Test

...
import static org.mockito.ArgumentMatchers.anyD
...
public class JwtServiceTest {
    ...
    void testIsTokenExpired() {
        ...
        Date expiration = new Date(System.currentTimeMillis() - 1000); // Date dans le passé
        given(jwtService.extractExpiration(eq(expiredToken))).willReturn(expiration);
        given(expiration.before(anyDa))

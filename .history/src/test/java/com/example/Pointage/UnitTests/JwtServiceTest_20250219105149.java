...
public class JwtServiceTest {
    ...
    void testGenerateAccessToken() {
        ...
        given(jwtService.createToken(anyMap(), eq(userName), eq(accessExpiration)))
                .willReturn(expectedToken);
        given(jwtService.generateAccessToken(userName))
    ...
    void testIsTokenInvalid() {
        ...
        // Assert
        assertFalse(isValid, "Le token ne devrait pas être valide");
    }
    ...
    void testCreateTokenIndirectly() {
        ...
        // Assert
        assertNotNull(actualToken, "Le token ne doit pas être null");
        assertTrue(actualToken.startsWith("eyJ"), "Le token devrait commencer par 'eyJ' (JWT valide)");
    }
}

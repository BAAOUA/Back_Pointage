...
public class JwtServiceTest {
    ...
    void testCreateTokenIndirectly() {
      ...
      given(jwtService.createToken(claims, userName, to))
              .willReturn(expectedToken);

      String token = jwtService.createToken(claims, userName, to);
    ...
    void testExtractExpiration() {
        String token = "validToken";
        Date expiration = new Date(System.currentTimeMillis() + to);

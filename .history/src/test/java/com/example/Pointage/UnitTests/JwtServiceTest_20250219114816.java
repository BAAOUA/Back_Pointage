...
public class JwtServiceTest {
    ...
    void testIsTokenExpired() {
        ...
        Date expiredDate = new Date(System.currentTimeMillis() - 100000); // Date dans le passé
        given(jwtService.extractExpiration(expiredToken)).willReturn(expiredDate);

        // Act
        boolean isExpired = jwtService.isTokenExpired(expiredToken);

  
        assertTrue(expiredDate.before(new Date(System.currentTimeMillis());
    }
